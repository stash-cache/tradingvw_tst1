...
indicator("GHOST WICK v7.5 ◎ SUPERIOR", overlay=true, max_lines_count=500, max_boxes_count=500, max_labels_count=500)
...
alertcondition(enter_long, "◉ LONG", "v7.5: trend long entry")
alertcondition(enter_short, "◉ SHORT", "v7.5: trend short entry")
alertcondition(enter_range_long, "◉ FADE LONG", "v7.5: range fade long")
alertcondition(enter_range_short,"◉ FADE SHORT", "v7.5: range fade short")
alertcondition(enter_cont_long, "◉ CONT LONG", "v7.5: continuation long")
alertcondition(enter_cont_short, "◉ CONT SHORT", "v7.5: continuation short")
alertcondition(enter_disp_long, "◉ DISP LONG", "v7.5: displacement breakout long — trend + RVOL + CVD + body dominance")
alertcondition(enter_disp_short, "◉ DISP SHORT", "v7.5: displacement breakout short — trend + RVOL + CVD + body dominance")
alertcondition(enter_abs_long, "◉ ABSORB LONG", "v7.5: absorption breakout/spring long")
alertcondition(enter_abs_short, "◉ ABSORB SHORT", "v7.5: absorption breakout/upthrust short")
alertcondition(move_to_manage, "◈ TP1 HIT", "v7.5: partial TP, trailing")
alertcondition(obv_exit_fired, "◈ OBV EXIT", "v7.5: OBV flow exit — distribution detected")
alertcondition(rev_exit_fired, "◈ REV EXIT", "v7.5: Reversal exit — REV + RSI divergence against trade while in profit")
alertcondition(macro_exit_fired, "◈ MACRO EXIT", "v7.5: Macro reversal exit — all 4 display TFs unanimously oppose trade direction while in profit for 2+ bars")
alertcondition(retest_reentry, "◉ RE-ENTRY", "v7.5: retest re-entry at structural zone")
alertcondition(exit_win, "✓ WIN", "v7.5: trade closed in profit")
alertcondition(exit_loss, "✗ EXIT", "v7.5: stopped or invalidated")
alertcondition(escape_ready, "↑ L1→L2 ESCAPE", "v7.5: probationary L1→L2 promotion escape — bootstrap trap breaker")
alertcondition(shakeout_routed, "○ SHAKEOUT WATCH", "v7.5: CONT stop-out routed to shakeout re-entry watch — trend + HTF + CVD intact")
alertcondition(stalk_prob_dissolved, "⊙ STALK DISSOLVED", "v7.5: stalking dissolved — probability + HTF oppose stalk direction + flow unsupported for 3 bars")
```
