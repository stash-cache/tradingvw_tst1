# Ghost Wick v5.0 — PRE-CATALYST DETECTION ◎ SUPERIOR
...
// ═══════════════════════════════════════════════════════════
// PRE-CATALYST DETECTION v5.0 ◎ SUPERIOR
//
// v5.0 CHANGES:
...
indicator("GHOST WICK v5.0 ◎ SUPERIOR", overlay=true, max_lines_count=500, max_boxes_count=500, max_labels_count=500)
...
if barstate.islast
    ...
    table.cell(d, 0, 0, "GHOST WICK v5.0 ◎", text_color=color.white, text_size=size.normal, bgcolor=color.new(color.black,35))
...
alertcondition(enter_loaded, "◎ LOADED", "v5.0: loaded at liquidity level")
alertcondition(enter_stalk, "⊙ STALKING", "v5.0: stalking — pre-HTF loaded at reversal zone")
alertcondition(enter_long, "◉ LONG", "v5.0: trend long entry")
alertcondition(enter_short, "◉ SHORT", "v5.0: trend short entry")
alertcondition(enter_range_long, "◉ FADE LONG", "v5.0: range fade long")
alertcondition(enter_range_short,"◉ FADE SHORT", "v5.0: range fade short")
alertcondition(enter_cont_long, "◉ CONT LONG", "v5.0: continuation long")
alertcondition(enter_cont_short, "◉ CONT SHORT", "v5.0: continuation short")
alertcondition(enter_disp_long, "◉ DISP LONG", "v5.0: displacement breakout long — trend + RVOL + CVD + body dominance")
alertcondition(enter_disp_short, "◉ DISP SHORT", "v5.0: displacement breakout short — trend + RVOL + CVD + body dominance")
alertcondition(enter_abs_long, "◉ ABSORB LONG", "v5.0: absorption breakout/spring long")
alertcondition(enter_abs_short, "◉ ABSORB SHORT", "v5.0: absorption breakout/upthrust short")
alertcondition(move_to_manage, "◈ TP1 HIT", "v5.0: partial TP, trailing")
alertcondition(obv_exit_fired, "◈ OBV EXIT", "v5.0: OBV flow exit — distribution detected")
alertcondition(rev_exit_fired, "◈ REV EXIT", "v5.0: Reversal exit — REV + RSI divergence against trade while in profit")
alertcondition(retest_reentry, "◉ RE-ENTRY", "v5.0: retest re-entry at structural zone")
alertcondition(exit_win, "✓ WIN", "v5.0: trade closed in profit")
alertcondition(exit_loss, "✗ EXIT", "v5.0: stopped or invalidated")
alertcondition(bb_squeeze and not bb_squeeze[1], "◆ BB SQUEEZE START", "v5.0: Bollinger Band squeeze active — compression phase detected")
alertcondition(bb_expanding and not bb_expanding[1] and bb_squeeze_ctx, "◆ BB SQUEEZE BREAKOUT", "v5.0: BB squeeze expanding — breakout imminent")
alertcondition(rev_bull, "◆ REV BULL", "v5.0: Momentum reversal bull — sweep + RVOL at sellside liquidity")
...
alertcondition(demand_zone_fresh and not demand_zone_fresh[1], "DEMAND ZONE FRESH TOUCH", "v5.0: Fresh demand zone first touch — highest-quality institutional level")
alertcondition(supply_zone_fresh and not supply_zone_fresh[1], "SUPPLY ZONE FRESH TOUCH", "v5.0: Fresh supply zone first touch — highest-quality institutional level")
