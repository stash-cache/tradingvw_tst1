# Ghost Wick v5.9 — PRE-CATALYST DETECTION ◎ SUPERIOR
...
indicator("GHOST WICK v5.9 ◎ SUPERIOR", overlay=true, max_lines_count=500, max_boxes_count=500, max_labels_count=500)
...
if barstate.islast
    ...
    table.cell(d, 0, 0, "GHOST WICK v5.9 ◎", text_color=color.white, text_size=size.normal, bgcolor=color.new(color.black,35))
...
alertcondition(enter_long, "◉ LONG", "v5.9: trend long entry")
alertcondition(enter_short, "◉ SHORT", "v5.9: trend short entry")
alertcondition(enter_range_long, "◉ FADE LONG", "v5.9: range fade long")
alertcondition(enter_range_short,"◉ FADE SHORT", "v5.9: range fade short")
alertcondition(enter_cont_long, "◉ CONT LONG", "v5.9: continuation long")
alertcondition(enter_cont_short, "◉ CONT SHORT", "v5.9: continuation short")
alertcondition(enter_disp_long, "◉ DISP LONG", "v5.9: displacement breakout long — trend + RVOL + CVD + body dominance")
alertcondition(enter_disp_short, "◉ DISP SHORT", "v5.9: displacement breakout short — trend + RVOL + CVD + body dominance")
alertcondition(enter_abs_long, "◉ ABSORB LONG", "v5.9: absorption breakout/spring long")
alertcondition(enter_abs_short, "◉ ABSORB SHORT", "v5.9: absorption breakout/upthrust short")
alertcondition(move_to_manage, "◈ TP1 HIT", "v5.9: partial TP, trailing")
alertcondition(obv_exit_fired, "◈ OBV EXIT", "v5.9: OBV flow exit — distribution detected")
alertcondition(rev_exit_fired, "◈ REV EXIT", "v5.9: Reversal exit — REV + RSI divergence against trade while in profit")
alertcondition(retest_reentry, "◉ RE-ENTRY", "v5.9: retest re-entry at structural zone")
alertcondition(exit_win, "✓ WIN", "v5.9: trade closed in profit")
alertcondition(exit_loss, "✗ EXIT", "v5.9: stopped or invalidated")
```
