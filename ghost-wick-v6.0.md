# Ghost Wick v6.0 — PRE-CATALYST DETECTION ◎ SUPERIOR
...
// ═══════════════════════════════════════════════════════════
// PRE-CATALYST DETECTION v6.0 ◎ SUPERIOR
//
// v6.0 CHANGES:
...
indicator("GHOST WICK v6.0 ◎ SUPERIOR", overlay=true, max_lines_count=500, max_boxes_count=500, max_labels_count=500)
...
if barstate.islast
    ...
    table.cell(d, 0, 0, "GHOST WICK v6.0 ◎", text_color=color.white, text_size=size.normal, bgcolor=color.new(color.black,35))
...
// [v6.0 #5] +1 alertcondition for probationary L1→L2 escape → 17 total. Within v6 plot budget (64).
alertcondition(enter_long, "◉ LONG", "v6.0: trend long entry")
alertcondition(enter_short, "◉ SHORT", "v6.0: trend short entry")
alertcondition(enter_range_long, "◉ FADE LONG", "v6.0: range fade long")
alertcondition(enter_range_short,"◉ FADE SHORT", "v6.0: range fade short")
alertcondition(enter_cont_long, "◉ CONT LONG", "v6.0: continuation long")
alertcondition(enter_cont_short, "◉ CONT SHORT", "v6.0: continuation short")
alertcondition(enter_disp_long, "◉ DISP LONG", "v6.0: displacement breakout long — trend + RVOL + CVD + body dominance")
alertcondition(enter_disp_short, "◉ DISP SHORT", "v6.0: displacement breakout short — trend + RVOL + CVD + body dominance")
alertcondition(enter_abs_long, "◉ ABSORB LONG", "v6.0: absorption breakout/spring long")
alertcondition(enter_abs_short, "◉ ABSORB SHORT", "v6.0: absorption breakout/upthrust short")
alertcondition(move_to_manage, "◈ TP1 HIT", "v6.0: partial TP, trailing")
alertcondition(obv_exit_fired, "◈ OBV EXIT", "v6.0: OBV flow exit — distribution detected")
alertcondition(rev_exit_fired, "◈ REV EXIT", "v6.0: Reversal exit — REV + RSI divergence against trade while in profit")
alertcondition(retest_reentry, "◉ RE-ENTRY", "v6.0: retest re-entry at structural zone")
alertcondition(exit_win, "✓ WIN", "v6.0: trade closed in profit")
alertcondition(exit_loss, "✗ EXIT", "v6.0: stopped or invalidated")
alertcondition(escape_ready, "↑ L1→L2 ESCAPE", "v6.0: probationary L1→L2 promotion escape — bootstrap trap breaker")
```
