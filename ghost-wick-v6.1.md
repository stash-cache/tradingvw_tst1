# Ghost Wick v6.1 — PRE-CATALYST DETECTION ◎ SUPERIOR
...
indicator("GHOST WICK v6.1 ◎ SUPERIOR", overlay=true, max_lines_count=500, max_boxes_count=500, max_labels_count=500)
...
if barstate.islast
    ...
    table.cell(d, 0, 0, "GHOST WICK v6.1 ◎", text_color=color.white, text_size=size.normal, bgcolor=color.new(color.black,35))
...
// [v6.1 BUG-J] +1 alertcondition for shakeout routing → 18 total. Within v6 plot budget (64).
alertcondition(enter_long, "◉ LONG", "v6.1: trend long entry")
alertcondition(enter_short, "◉ SHORT", "v6.1: trend short entry")
alertcondition(enter_range_long, "◉ FADE LONG", "v6.1: range fade long")
alertcondition(enter_range_short,"◉ FADE SHORT", "v6.1: range fade short")
alertcondition(enter_cont_long, "◉ CONT LONG", "v6.1: continuation long")
alertcondition(enter_cont_short, "◉ CONT SHORT", "v6.1: continuation short")
alertcondition(enter_disp_long, "◉ DISP LONG", "v6.1: displacement breakout long — trend + RVOL + CVD + body dominance")
alertcondition(enter_disp_short, "◉ DISP SHORT", "v6.1: displacement breakout short — trend + RVOL + CVD + body dominance")
alertcondition(enter_abs_long, "◉ ABSORB LONG", "v6.1: absorption breakout/spring long")
alertcondition(enter_abs_short, "◉ ABSORB SHORT", "v6.1: absorption breakout/upthrust short")
alertcondition(move_to_manage, "◈ TP1 HIT", "v6.1: partial TP, trailing")
alertcondition(obv_exit_fired, "◈ OBV EXIT", "v6.1: OBV flow exit — distribution detected")
alertcondition(rev_exit_fired, "◈ REV EXIT", "v6.1: Reversal exit — REV + RSI divergence against trade while in profit")
alertcondition(retest_reentry, "◉ RE-ENTRY", "v6.1: retest re-entry at structural zone")
alertcondition(exit_win, "✓ WIN", "v6.1: trade closed in profit")
alertcondition(exit_loss, "✗ EXIT", "v6.1: stopped or invalidated")
alertcondition(escape_ready, "↑ L1→L2 ESCAPE", "v6.1: probationary L1→L2 promotion escape — bootstrap trap breaker")
alertcondition(shakeout_routed, "○ SHAKEOUT WATCH", "v6.1: CONT stop-out routed to shakeout re-entry watch — trend + HTF + CVD intact")
```
